...
public class PluginAdapter {
    ...
    public static void startPluginAdapter(String name, String uname, String url, String token) throws Exception
    {
        ...
        AdapterCore adapter_core = new AdapterCore(name, uname, connectionBroker, handler);
    ...
    public static void main(String[] args) throws Exception {
        ...
        startPluginAdapter(name, uname, url, token);
    }
